...
WebDriver driver;
	...
	public void testPageTitleSample1() {
		...
		Assert.assertTrue(strPageTitle.equalsIgnoreCase("Google"), "Page title doesn't match");//This is used to compare expected and actual values in selenium webdrive
	}
